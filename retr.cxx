...
int main ( int argc, char** argv )
 {
  ...
  double um1(0), um2(0), um3(0), um4(0), um5(0), um6(0);
  bool end_run(false);
  ...
  */
  ...
  printf ( "average time for 2 x scal4xxx.readcounter %lf\n\n", um3 );
  printf ( "average time for scalped.clear %lf\n\n", um4 );
  printf ( "average time for 0.2*ioreg.outputsetreg %lf\n\n", um5 );
  printf ( "average time for ioreg.multihitreadclearreg+ioreg.singlehitreadclearreg %lf\n\n", um6 );
  system ( "date" );
  printf ( "\n" );
